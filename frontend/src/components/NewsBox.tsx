...
export const NewsBox = () => {
  ...
  return <div className="bg-gray-800 rounded-lg shadow-md mb-6 card-hover-subtle">
      <div className="p-4 border-b border-gray-700 flex justify-between items-center">
        <h2 className="text-lg font-semibold flex items-center">
          <NewspaperIcon size={18} className="mr-2" />
          Latest News
        </h2>
        <button className="text-sm text-blue-400 hover:text-blue-300 flex items-center button-hover">
          View all
