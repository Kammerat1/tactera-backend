...
from tactera_backend.models.models import TrainingHistory, TrainingHistoryStat
...
from tactera_backend.services.xp_helper import calculate_level_from_xp
from tactera_backend.services.xp_helper import add_xp_to_stat  # Import the helper we just made
