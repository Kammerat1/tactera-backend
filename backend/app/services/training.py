...
from app.models.club_model import Club # Club model
from app.models.training_model import TrainingGround  # Core model
from app.models.player_stat_model import PlayerStat  # Stat model lives in separate file
from app.models.player_model import Player  # Player model lives in separate file
from fastapi import APIRouter, HTTPException, Depends
from sqlmodel import Session, select
from datetime import date
from app.core.database import get_session
from app.models.club_model import Club
from app.core.training_intensity import get_xp_multiplier, calculate_energy_drain
...
from app.models.injury_model import Injury  # ✅ Needed to check injuries
