...
from app.models.club_schemas import ClubRegister
from app.models.player_model import Player
from app.models.training_model import TrainingGround, TrainingHistory, TrainingHistoryStat
from app.models.player_stat_model import PlayerStat, get_stat_level
from app.services.training import calculate_training_xp, split_xp_among_stats, DRILLS
from datetime import datetime, date
from pydantic import BaseModel
from app.core.config import TEST_MODE  # Import TEST_MODE for cooldown logic
import random
...
def train_club(club_id: int, data: TrainingRequest, session: Session = Depends(get_session)):
    ...
    from app.core.config import TEST_MODE  # ✅ Import locally inside the function
    ...
    from app.services.training import apply_training_with_injury_check
    updated_players = []
...
def get_latest_training_session(
    ...
    from app.models.training_model import TrainingHistory, TrainingHistoryStat
    from app.models.player_model import Player
...
from app.models.player_model import Player, PlayerRead
