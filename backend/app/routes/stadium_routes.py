...
from app.core.database import get_db, sync_engine, Session
from app.models.stadium_model import Stadium, StadiumPart
from app.services.stadium_service import upgrade_stadium_part
from sqlalchemy.ext.asyncio import AsyncSession
from app.models.club_model import Club
from app.services.finance_service import calculate_match_revenue
...
async def upgrade_all_stands(stadium_id: int, db: AsyncSession = Depends(get_db)):
    ...
    from app.services.stadium_service import recalculate_stadium_attributes
...
async def get_stadium_financial_summary(
    ...
    from app.core.stadium_config import LEVEL_TO_CAPACITY
