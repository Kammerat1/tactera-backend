...
from app.models.formation_model import MatchSquad, MatchSubstitution, SubstitutionRequest
from app.routes.substitution_routes import validate_substitution_request
from app.core.database import get_session, sync_engine
from app.models.formation_model import MatchSquad, MatchSubstitution, SubstitutionRequest
from app.routes.substitution_routes import validate_substitution_request
from app.models.contract_model import PlayerContract
...
from app.core.training_intensity import ALLOWED_INTENSITIES
...
from app.models.player_model import Player
from app.models.injury_model import Injury
from app.core.injury_config import RECENT_HEALED_WINDOW_DAYS
...
from app.models.player_model import Player
from app.models.suspension_model import Suspension
from app.core.database import get_session
...
async def debug_simulate_match_with_substitutions(
    ...
    """
    from app.core.match_sim import simulate_match_with_substitutions
...
async def debug_complete_transfers(db: AsyncSession = Depends(get_db)):
    ...
    """
    from app.services.transfer_completion_service import process_expired_auctions
...
async def debug_expire_auction(listing_id: int, db: AsyncSession = Depends(get_db)):
    ...
    """
    from app.models.contract_model import TransferListing
    from datetime import datetime, timedelta
...
async def debug_transfer_status(db: AsyncSession = Depends(get_db)):
    ...
    """
    from app.models.contract_model import TransferListing, AuctionStatus
    from sqlmodel import select
