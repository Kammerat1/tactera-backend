...
from app.models.stat_level_requirement_model import StatLevelRequirement
from app.services.xp_helper import calculate_level_from_xp, add_xp_to_stat
from typing import Optional
from app.services.injury_service import tick_injuries
