...
from app.models.stadium_model import Stadium
from app.models.injury_model import Injury
from app.core.injury_generator import calculate_injury_risk, generate_injury
from app.core.injury_config import REINJURY_MULTIPLIER
from app.core.config import TEST_MODE
from app.models.suspension_model import Suspension
from app.models.formation_model import ClubFormation, FormationTemplate, MatchSquad, MatchSubstitution
...
async def simulate_match_with_substitutions(db: AsyncSession, fixture_id: int):
    ...
    # =========================================
    from app.services.finance_service import calculate_match_revenue, add_revenue
